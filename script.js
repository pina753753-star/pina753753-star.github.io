...
const DESIGN_QUALITY_PROMPT = `## デザイン品質
簡易的なサンプルではなく、実際にお客さんへ納品できる完成度のUIにしてください。
ただのフォーム画面ではなく、余白・配色・見出し・カード・ボタン・入力欄の見た目まで整えた、スマホで見やすい完成デザインにしてください。
...
- 見出しに強弱をつける
- カードごとに情報を整理する
- ボタンは大きく、押したくなる見た目にする
- 入力欄は角丸で、スマホでも押しやすくする
- 色数は増やしすぎず、統一感を出す
- PCでは中央にスマホ幅で表示する
- 完成後に「納品できる見た目か」を確認して調整する`;
